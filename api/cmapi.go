...
type CMApi interface {
	...
	Map(ctx context.Context, parm string) error    //perm:none
	Load(ctx context.Context, parm string) error   //perm:none
	Unload(ctx context.Context, parm string) error //perm:none
	Home(ctx context.Context, parm string) error   //perm:none
}
